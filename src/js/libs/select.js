...
// data-tags — режим тегов (только для multiple), позволяет вставлять
// выбранные значения в виде тегов с крестиком для удаления. Также
// есть возможность выводить эти теги в любом указанном месте,
// указав селектор блока в качестве значения атрибута