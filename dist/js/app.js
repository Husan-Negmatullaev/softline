(() => {
    ...
    (() => {
        ...
        function buildSlider() {
            ...
            if (sliders.length > 0) sliders.forEach((slider => {
        ...
        function initSliders() {
            buildSlider();
            if (document.querySelector(".corporate-life__slider")) new core(".corporate-life__slider", {
        ...
        function digitsAnimation() {
            function digitsCountersInit(digitsCountersItems) {
                ...
                if (digitsCounters) digitsCounters.forEach((digitCounter => {
        ...
        function handleDropdownClick(targetElement) {
            ...
            if (window.innerWidth > 991) if (!targetElement.closest("[data-dropdown-button]") && document.querySelectorAll("[data-dropdown-button]._active-dropdown").length) {
        ...
        function handleMapClick(targetElement) {
            if (targetElement.closest("[data-map-title]")) {
                ...
                if (targetElement.closest("[data-map-regions]")) {
                    ...
                    if (mapAreas.querySelector("[data-map-title]._active")) mapAreas.querySelector("[data-map-title]._active").classList.remove("_active");
                ...
                if (targetElement.closest("[data-map-areas]")) {
                    ...
                    if (mapRegions.querySelector("[data-map-title]._active")) mapRegions.querySelector("[data-map-title]._active").classList.remove("_active");
